  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#1B2340' }}>
      <header className="border-b p-6 flex justify-between items-center" style={{ borderColor: 'rgba(201, 168, 76, 0.3)' }}>
        <div>
          <h1 className="font-cormorant text-4xl" style={{ color: '#FFFFFF' }}>
            Welcome, {profile?.full_name || 'Partner'}
          </h1>
          <p className="font-montserrat text-xs mt-2" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
            Partner Dashboard
          </p>
        </div>
        <button
        ...
        <section className="mb-16">
          ...
          <div className="border p-8 h-64 flex items-center justify-center" style={{ borderColor: 'rgba(201, 168, 76, 0.3)' }}>
            <p className="font-cormorant text-2xl" style={{ color: 'rgba(255, 255, 255, 0.5)' }}>
              Partnership metrics and overview coming soon
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[1, 2, 3, 4].map((num) => (
              <div
                key={num}
                className="border p-6 h-48 flex items-center justify-center"
                style={{ borderColor: 'rgba(201, 168, 76, 0.3)' }}
              >
                <p className="font-cormorant text-xl" style={{ color: 'rgba(255, 255, 255, 0.5)' }}>
                  Resource {num}
                </p>
              </div>
            ))}
