  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl w-full fade-in relative z-10">
        <p
          className="font-montserrat text-xs tracking-[0.35em] uppercase text-center mb-6"
        ...
        <h2
          className="font-cormorant text-4xl md:text-5xl text-center mb-3 max-w-4xl mx-auto"
        ...
        <div className="mb-20 max-w-5xl mx-auto">
          <div className="grid grid-cols-2 border" style={{ borderColor: 'var(--color-gold)', borderWidth: '1px' }}>
            ...
            >
              <p
                className="font-montserrat text-xs tracking-[0.25em] uppercase text-center"
            ...
            >
              <p
                className="font-baskerville text-sm text-center"
                style={{ color: 'var(--color-white)' }}
              >
                Revenue tied to rep performance
              </p>
            </div>
            <div
              className="p-6 border-b"
            ...
            >
              <p
                ...
                style={{ color: 'var(--color-white)' }}
              >
                Pipeline visibility is retrospective
              </p>
            </div>
            <div
              className="p-6 border-b"
            ...
            >
              <p
                ...
                style={{ color: 'var(--color-gold-light)' }}
              >
                Pipeline intelligence is predictive.
              </p>
            </div>
            ...
            >
              <p
                ...
                style={{ color: 'var(--color-white)' }}
              >
                Hiring scales cost before it scales output
              </p>
            </div>
            <div
              className="p-6 border-b"
            ...
            >
              <p
                ...
                style={{ color: 'var(--color-gold-light)' }}
              >
                Architecture scales output without headcount.
              </p>
            </div>
            ...
            <div className="p-6">
              <p
                ...
                style={{ color: 'var(--color-gold-light)' }}
              >
                Signal lives in behavioral timing layers.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative" style={{ width: '480px', height: '480px', maxWidth: '90vw', maxHeight: '90vw' }}>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                />
                <p
                  className="font-montserrat uppercase mt-3 text-center max-w-[180px]"
                  style={{
                    color: '#C9A84C',
                    fontSize: '10px',
                    fontWeight: 500,
        ...
        {/* Centered italic statement */}
        <p
          className="font-baskerville text-lg italic text-center mb-6 max-w-3xl mx-auto"
          style={{ color: 'var(--color-white)' }}
        >
          We do not optimize pipelines. We replace the conditions that make optimization necessary.
        </p>

        {/* Gold spaced-caps line */}
        <p
          className="font-montserrat text-xs tracking-[0.25em] uppercase text-center"
          style={{ color: 'var(--color-gold)' }}
        >
